"""Deterministic, non-invasive email security checks for ShieldSense.

This module only inspects supplied text and metadata. It never opens attachments,
fetches links, or performs any mailbox mutation.
"""
